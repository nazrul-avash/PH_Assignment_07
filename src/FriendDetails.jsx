...
console.log(handleActivity);
    return (
        <div className='flex flex-col lg:flex-row gap-5 pt-20 mb-10 px-2'>
          ...
          <div className='basis-[70%]'>
               <div className='grid grid-cols-1 md:grid-cols-3 gap-5 mb-10 px-2'>
            ...
            <div className='bg-white shadow-md text-center px-10 py-12 rounded-xl'>
                <h1 className='text-[#244D3F] font-semibold text-2xl'>{expectedfriend.next_due_date}</h1>
        ...
        <div className='bg-white shadow-md  px-15 py-12 rounded-xl mb-4 '>
                ...
                <div className='flex gap-2 justify-between flex-col md:flex-row'>
                    <button className='flex flex-col cursor-pointer bg-[#E9E9E9] px-20 py-8 rounded-2xl justify-center items-center text-[20px]' onClick={()=>handleActivity(expectedfriend.name,"Call",new Date())}> <LuPhoneCall />Call</button>
                <button className='flex  flex-col cursor-pointer bg-[#E9E9E9] px-20 py-8 rounded-2xl justify-center items-center text-[20px]'
